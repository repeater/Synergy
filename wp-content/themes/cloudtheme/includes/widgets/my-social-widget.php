...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$networks['Last']['link'] = $instance['last'];
		...
		$networks['Last']['label'] = $instance['last_label'];
		...
		?>
			...
			<ul class="social-networks">
					...
					<?php foreach(array("Twitter", "Facebook", "Last", "Flickr", "Feed", "Linkedin", "Delicious") as $network) : ?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['last_label'] = $new_instance['last_label'];
	...
	function form( $instance ) {
		...
		$last_label = $instance['last_label'];
...
?>
    ...
    <fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			<legend style="padding:0 5px;"><?php _e('Last.fm'); ?>:</legend>
    <p><label for="<?php echo $this->get_field_id('last'); ?>"><?php _e('Last.fm URL:'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('last'); ?>" name="<?php echo $this->get_field_name('last'); ?>" type="text" value="<?php echo esc_attr($last); ?>" /></p>
        <p><label for="<?php echo $this->get_field_id('last_label'); ?>"><?php _e('Last.fm label:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('last_label'); ?>" name="<?php echo $this->get_field_name('last_label'); ?>" type="text" value="<?php echo esc_attr($last_label); ?>" /></p>
        </fieldset>	
