...
<a href="http://flickr.com/photos/<?php echo $flickr_id ?>" class="link"><?php echo $linktext; ?></a>
    ...
    function form($instance) {				
      ...
      <p><label for="<?php echo $this->get_field_id('linktext'); ?>"><?php _e('Link Text:', 'theme1377'); ?> <input class="widefat" id="<?php echo $this->get_field_id('linktext'); ?>" name="<?php echo $this->get_field_name('linktext'); ?>" type="text" value="<?php echo $linktext; ?>" /></label></p>	
