...
class MY_PostWidget extends WP_Widget {
  ...
  /** @see WP_Widget::widget */
              ...
              <?php echo $before_widget; ?>
                  <?php if ( $title )
						...
						<?php  $temp = $wp_query;
                           ...
                           <div class="excerpt">
                           	<p><?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,18);?></p>
    ...
    function form($instance) {				
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Category Slug:', 'my_framework'); ?> <input class="widefat" id="<?php echo $this->get_field_id('category'); ?>" name="<?php echo $this->get_field_name('category'); ?>" type="text" value="<?php echo $category; ?>" /></label></p>
