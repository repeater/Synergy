<?php
/**
 * Template Name: Product 4 columns
 */
...
<div id="gallery" class="four_columns">
  <ul class="portfolio">
    ...
    ?>
      ...
      <?php }else{ ?>
        <span class="image-border"><a class="image-wrap" href="<?php the_permalink() ?>" title="<?php _e('Permanent Link to', 'my_framework');?> <?php the_title_attribute(); ?>" ><?php the_post_thumbnail( 'portfolio-post-thumbnail-small' ); ?></a></span>
        <?php } ?>
